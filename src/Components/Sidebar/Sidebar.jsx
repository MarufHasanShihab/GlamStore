...
const Sidebar = () => {
    ...
    return (
        <div className={`${open ? "right-0":"-right-full"} w-full h-full bg-white fixed top-0 shadow-2xl sm:w-[55vw] md:w-[44] xl:max-w-[27vw] transition-all duration-300 x-20 lg:px-[35px] overflow-auto py-4 pb-6 `}>
