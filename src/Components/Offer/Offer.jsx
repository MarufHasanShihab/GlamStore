  ...
  return(
    <section className="max-padd-container bg-banner bg-center bg-cover h-[555px] p-8 rounded-xl">
        <div className="flex items-center flex-col gap-1 mt-40 max-w-xl">
            ...
            <div className="flex gap-x-4  xs:gap-x-7 mt-1">
